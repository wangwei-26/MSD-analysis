...
## System Requirements
The uploaded code should work on any system able to execute Python and import the scipy.optimize package. The existing scripts have been tested on Python/3.10.6, and do not have specific hardware requirements.
